...
class MotorTest(unittest.Testcase):
    ...
    def test_put_freq(self):
        ...
        self.file_check('rtmotor_raw_r0', m.right_hz, 'wrong right value from
        motor_raw')
    ...
    def test_put_cmd_vel(self):
        ...
        self.file_check('rtmotor_raw_l0', 200, 'wronge left value frmm cmd_vel')
        self.file_check('rtmotor_raw_r0', 600, 'wronge right value from
        cmd_vel')
